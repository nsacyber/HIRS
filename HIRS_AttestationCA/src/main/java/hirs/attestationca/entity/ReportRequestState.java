...
import hirs.data.persist.State;
...
public class ReportRequestState extends State {
    ...
    /**
     * When a {@link hirs.data.persist.Report} is due for to fulfill this request.
     *
    ...
    /**
     * Sets when a {@link hirs.data.persist.Report} is due to fulfill this request.
     *
    ...
    /**
     * Sets when a {@link hirs.data.persist.Report} is due to fulfill this request by computing the current
