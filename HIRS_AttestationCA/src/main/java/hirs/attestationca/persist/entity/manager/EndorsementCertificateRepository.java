 ...
 *
 * <p>
 * The {@link EndorsementCertificateRepository} interface extends {@link JpaRepository} to provide basic CRUD operations,
 ...
 */
@Repository
public interface EndorsementCertificateRepository extends JpaRepository<EndorsementCredential, UUID> {
