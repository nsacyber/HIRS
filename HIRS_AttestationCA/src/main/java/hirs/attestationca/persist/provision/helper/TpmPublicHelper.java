...
public final class TpmPublicHelper {
    ...
    /**
     * Private utility class to traverse TPMT_PUBLIC structures via a given byte array.
     */
    private static final class Cursor {
        ...
        /**
         * Reads an unsigned 16-byte integer from the TPMT_PUBLIC structure.
         * @return an {@code int} value corresponding to the read values
         */
        int readU16() {
            require(2);
        ...
        /**
         * Reads an unsigned 32-byte integer from the TPMT_PUBLIC structure.
         * @return a {@code long} value corresponding to the read values
         */
        long readU32() {
            require(4);
        ...
        /**
         * Reads a TPM2B byte array from the TPMT_PUBLIC structure.
         * @return a byte array corresponding to the read TPM2B structure
         */
        byte[] readTpm2b() {
            int size = readU16();
            require(size);
        ...
        /** Skips (traverses over) reading a TPM2B structure. */
        void skipTpm2b() {
            int size = readU16();
            skip(size);
        }
        ...
        /**
         * Skips (traverses over) a sequence of {@code n} bytes.
         * @param n the bytes to skip
         */
        void skip(int n) {
            require(n);
            pos += n;
        ...
        /**
         * Safety method to ensure {@code n} bytes are within the bounds of a TPMT_PUBLIC structure.
         * @param n the bytes to check
         */
        void require(int n) {
            if (pos + n > buf.length) {
