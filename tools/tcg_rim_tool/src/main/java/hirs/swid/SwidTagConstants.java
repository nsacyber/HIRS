...
public final class SwidTagConstants {
    ...
    public static final String SHA256_NS = "http://www.w3.org/2001/04/xmlenc#sha256";
    ...
    private SwidTagConstants() {
        throw new UnsupportedOperationException("SwidTagConstants is a utility class and cannot be instantiated");
    }
}
