...
public class TimestampArgumentValidator {
     ...
     */
    public TimestampArgumentValidator(final List<String> args) {
        this.args = args;
    }
     ...
     */
    private boolean isExactlyOneFormat(final List<String> args) {
     ...
     */
    private boolean isRfc3339Format(final String timestamp) {
        try {
     ...
     */
    private boolean isRfc3852FileValid(final String file) {
