...
<img src= "../../images/portal-issued.png" alt="Portal Issued Certs page" style="border: 2px solid grey;" class="portal-wide">

The user can view the details in the Issued Certificate by clicking the
...
<img src= "../../images/portal-issued-cert.png" alt="Portal Issued Certs details" style="border: 2px solid grey;" class="portal-wide">