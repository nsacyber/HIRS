...
A standard configuration is defined in the appsettings.json file. In this standard
configuration, the log file will appear in the directory that the HIRS .NET
Provisioner is executed from. The log name is formatted:
