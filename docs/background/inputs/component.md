...
ISO/IEC 19770-2 SWID tag. It is used for the same purpose - a globally unique tag identifying
...
COSE-signed. In other words it describes "what software is this" in a concise format.
...
*golden* measurements a Verifier should expect from a device. The TCG
defines a [RIM](rim.md) for PC Client as well as a 
...
for device components. The TCG Component RIM is expressed as a signed CoSWID whose link/meta 
