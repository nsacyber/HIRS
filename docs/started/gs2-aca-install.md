---
title: 2. Install the ACA
---

# Install the ACA

The ACA can be installed on either the device you are provisioning, or on a separate device. 
Typically in a real-world scenario the ACA server would be installed on a separate device, 
