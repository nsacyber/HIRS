...
$global:HIRS_DATA_SPRING_PROP_FILE=(Join-Path $global:HIRS_CONF_DIR 'application.properties')
...
#     HIRS Relative directories
#         scripts
#           aca
#             aca_bootRun
#             aca_common             # This script. You are here.
#             aca_setup
#           db
#             db_create
#             db_create.sql
...
#             pki_chain_gen
#             pki_setup
$global:HIRS_REL_SCRIPTS_ACA_HOME=(Split-Path -parent $PSCommandPath)
$global:HIRS_REL_SCRIPTS_HOME=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_ACA_HOME ..)
$global:HIRS_REL_SCRIPTS_ACA_BOOTRUN=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_ACA_HOME 'aca_bootRun.ps1')
$global:HIRS_REL_SCRIPTS_ACA_COMMON=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_ACA_HOME 'aca_common.ps1')
$global:HIRS_REL_SCRIPTS_ACA_SETUP=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_ACA_HOME 'aca_setup.ps1')
$global:HIRS_REL_SCRIPTS_DB_HOME=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_HOME "db")
$global:HIRS_REL_SCRIPTS_DB_CREATE=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_DB_HOME 'db_create.ps1')
$global:HIRS_REL_SCRIPTS_DB_CREATE_SQL=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_DB_HOME 'db_create.sql')
$global:HIRS_REL_SCRIPTS_DB_MYSQL_UTIL=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_DB_HOME 'mysql_util.ps1')
...
$global:HIRS_REL_SCRIPTS_PKI_CHAIN_GEN=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_PKI_HOME 'pki_chain_gen.ps1')
$global:HIRS_REL_SCRIPTS_PKI_SETUP=(Join-Path -Resolve $global:HIRS_REL_SCRIPTS_PKI_HOME 'pki_setup.ps1')
