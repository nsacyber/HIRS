...
/**
 * Controller for the Component RIM Details Page.
 */
@Controller
@RequestMapping("/HIRS_AttestationCAPortal/portal/component-rim-details")
@Log4j2
public class ComponentRimDetailsPageController extends PageController<ReferenceManifestDetailsPageParams> {

    private final ReferenceManifestDetailsPageService referenceManifestDetailsPageService;

    /**
     * Constructor for the Component RIM Details Page Controller.
     *
     * @param referenceManifestDetailsPageService reference manifest service
     */
    @Autowired
    public ComponentRimDetailsPageController(final ReferenceManifestDetailsPageService referenceManifestDetailsPageService) {
        super(Page.COMPONENT_RIM_DETAILS);
     ...
     */
    @Override
    public ModelAndView initPage(final ReferenceManifestDetailsPageParams params, final Model model) {
        ...
        if (params.getId() == null) {
            ...
            try {
                ...
                data.putAll(this.referenceManifestDetailsPageService.getComponentRimInfo(uuid));
            ...
            if (data.isEmpty()) {
                String notFoundMessage = "Unable to find Component RIM with ID: " + params.getId();
