...
/**
 * This class sets up hibernate settings.
 */
@Configuration
@PropertySources({
...
public class HibernateConfig {
    ...
    /**
     * Getter for the session factory bean.
     *
     * @return the session for the LocalSessionFactoryBean.
     */
    @Bean
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setPackagesToScan("hirs.attestationca.entity");
        return factoryBean;
    }
     ...
     * @return the manager for hibernate transactions.
     */
    @Bean
