        ...
        <div class="col col-md-6 index-left-side">
          ...
          <h3>
            <a href="${certificateRequest}/trust-chain">
              <img src="${icons}/ic_subtitles_black_24dp.png" /> Trust Chain
              Management
            </a>
          </h3>
          <h4>
            Upload, view and manage CA certificates that complete trust chains
            for hardware credentials.
          </h4>
          <h3>
          ...
          <h3>
            <a href="${certificateRequest}/endorsement-key-credentials">
              <img src="${icons}/ic_vpn_key_black_24dp.png" /> Endorsement
              Certificates
            </a>
          </h3>
          ...
          <h3>
            <a href="${certificateRequest}/idevid-certificates">
              <img src="${icons}/ic_important_devices_black_24dp.png" /> IDevID
              Certificates
            </a>
          </h3>
        ...
        <div class="col col-md-6 index-right-side">
          ...
          <h3>
            <a href="${certificateRequest}/issued-certificates">
              <img src="${icons}/ic_library_books_black_24dp.png" /> Issued
              Certificates
            </a>
          </h3>
          <h4>View Certificates issued by this CA</h4>
          <h3>
            <a href="${portal}/validation-reports"
              ><img src="${icons}/ic_assignment_black_24dp.png" /> Validation
              Reports</a
            >
          </h3>
          <h4>View a list of device validations carried out by this CA.</h4>
          <h3>
            <a href="${portal}/devices"
              ><img src="${icons}/ic_devices_black_24dp.png" /> Devices</a
            >
          </h3>
          <h4>View devices covered by this CA for supply chain validation.</h4>
          <h3>
            <a href="${portal}/rim-database"
              ><img src="${icons}/ic_devices_black_24dp.png" /> RIM Database</a
            >
          </h3>
