...
# 1.999999 - version bump used for rerunning tests
...
# 		self.assertTrue(result)
#  
# 		send_command_V2('touch /boot/usb-storage-foo.ko')
# 		#send_command_V2('sudo cat /tmp/usb-storage-foo.ko')
# 		result = run_hirs_report(CLIENT)
# 		self.assertFalse(result)
#  
# 		after_alerts = Portal.get_alerts_from_latest_report()
...
# # 		send_command_V2('touch /tmp/usb-storage_2.ko')
# # 		send_command_V2('echo blacklist >> /tmp/usb-storage_2.ko')
...
# # 		send_command_V2('sudo cat /tmp/usb-storage_2.ko')
# # 		result = run_hirs_report(CLIENT)
# # 		self.assertFalse(result)
# #  
# # 		after_alerts = Portal.get_alerts_from_latest_report()
...
# 		send_command_V2('echo {0} > {1}'.format("test", foo_file_name))
# 		send_command_V2('sudo cat {0}'.format(foo_file_name))
#  
# 		result = run_hirs_report(CLIENT)
