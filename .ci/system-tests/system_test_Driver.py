...
# PBASE1_LOCATION = HOME_DIR + ".ci/integration-tests/certs/PBase1.pem"
# PBASE2_LOCATION = HOME_DIR + ".ci/integration-tests/certs/PBase2.pem"
# PBASE3_LOCATION = HOME_DIR + ".ci/integration-tests/certs/PBase3.pem"
#
# PLAT_MAN1_CA_CERT = HOME_DIR + ".ci/integration-tests/certs/PlatformManufacturer1.CA.certificate.pem"
# PLAT_MAN1_PK = HOME_DIR + ".ci/integration-tests/certs/PlatformManufacturer1.CA.privatekey.pem"
#
# SYS_DELTA1_BASE2 = HOME_DIR + ".ci/integration-tests/certs/SystemIntDelta1.Base2.pem"
# SYS_DELTA1_BASE3 = HOME_DIR + ".ci/integration-tests/certs/SystemIntDelta1.Base3.pem"
#
# SYS_INT1_CA_CERT= HOME_DIR + ".ci/integration-tests/certs/SystemIntegrator1.CA.certificate.pem"
# SYS_INT1_PK = HOME_DIR + ".ci/integration-tests/certs/SystemIntegrator1.CA.privatekey.pem"
#
# VAL_ADD_RESELL1_CA_CERT= HOME_DIR + ".ci/integration-tests/certs/ValueAddedReseller1.CA.certificate.pem"
# VAL_ADD_RESELL1_PK = HOME_DIR + ".ci/integration-tests/certs/ValueAddedReseller1.CA.privatekey.pem"
#
# VAR_DELTA1_BASE3 = HOME_DIR + ".ci/integration-tests/certs/VARDelta1.Base3.pem"
...
#
#     @unittest.skipIf(not is_tpm2(TPM_VERSION), "Skipping this test due to TPM Version " + TPM_VERSION)
#     def test_19_A0_delta_certificate(self):
...
#         logging.info("Provisioning with Good Base Platform, 2 Good Delta Certs with 1 Delta cert replacing component from previous, using the Delta as a base certificate")
    ...
    def test_19_B1_delta_certificate(self):
        ...
        logging.info("Provisioning with Bad Platform Cert Base (ACA upload)")
        cert_list = AcaPortal.get_pk_certs()
        self.assertEqual(cert_list['recordsTotal'], 1)
        self.assertEqual(cert_list['data'][0]['credentialType'], "TCG Trusted Platform Endorsement")
